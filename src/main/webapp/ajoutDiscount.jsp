...
<html>
	...
	<body>
		...
		<div class="table">
			<div class="thead"><div class="td">Code</div><div class="td">Taux</div><div class="td">Action</div><div class="td"> Action </div></div>
			<div class="tbody">
			<c:forEach var="record" items="${codes}">
				<form class="tr" method="get">
					...
					<div class="td"><input type="submit" name="action" value="DELETE"/></div>
                                        ...
                                        <div class="td"><input type="submit" name="action" value="MAJ"/></div>
				</form>	  		    
			</c:forEach>  
			</div>
		</div>
